...
def check_statute_of_limitations(case_type: str) -> str:
    ...
    Các loại hỗ trợ:
    - contract: tranh chấp hoặc vi phạm hợp đồng
    - tort: bồi thường thiệt hại ngoài hợp đồng
    - property: tranh chấp tài sản
    """
    case_type_lower = case_type.lower()

    if "contract" in case_type_lower or "hợp đồng" in case_type_lower:
        return "Thời hiệu khởi kiện vi phạm hợp đồng thường là 4 năm (UCC § 2-725)."

    if "tort" in case_type_lower or "bồi thường" in case_type_lower:
        return "Thời hiệu khởi kiện tort thường là 2-3 năm tùy bang."

    if "property" in case_type_lower or "tài sản" in case_type_lower:
        return "Thời hiệu khởi kiện liên quan đến tài sản thường là 5 năm."

    return "Không xác định thời hiệu cho loại vụ án này."
